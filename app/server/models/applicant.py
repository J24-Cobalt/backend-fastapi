...
- Age
- Gender
- Intro (a very short description, see linkedIn for example)
- Avatar
- [{Work experience}]
- [{Education}]
- [Skills] (taken from some database or something)
- {Mental Profile}
- CV
- [{Application}]
"""
...
class Education(BaseModel):
    ...
    start_date: str  #YYYY-MM-DD
    end_date: Optional[str] = None  # YYYY-MM-DD or none if still employed
    gpa: Optional[float] = None  # if applicable
...
class ApplicantSchema(BaseModel):
    ...
    university_gpa: Optional[float] = Field(0.0, le=10.0)
